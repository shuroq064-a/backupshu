      ...
      <div className="relative z-10 m-auto w-full max-w-6xl overflow-hidden rounded-3xl border border-outline-variant/70 shadow-2xl dark:border-white/25 lg:grid lg:grid-cols-2">
        ...
        <div className="mx-auto w-full max-w-sm space-y-4">
          ...
          <div className="space-y-2">
            <button type="button" onClick={() => handleSocialLogin("google")} className="flex w-full items-center justify-center gap-2 rounded-xl border border-outline-variant bg-white px-4 py-3 text-sm font-semibold text-gray-800 shadow-sm transition-all hover:bg-gray-50 hover:shadow-md active:scale-[0.98] dark:bg-surface-container-low dark:text-on-surface dark:hover:bg-surface-container-lowest">
              <GoogleIcon className="me-3 h-6 w-6" />
